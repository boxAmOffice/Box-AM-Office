    ...
    public partial class AddTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ad376a8f", "a621b7bb-faed-4d37-b47c-30b65d5484d3", "Administrator", "Administrator" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "a18be9c0", 0, "b3158ee9-368e-416a-80b2-0d68e0013bb4", "Administrator@gmail.com", false, null, false, null, "Administrator@gmail.com", "Administrator", "AQAAAAEAACcQAAAAEJqNfpcg0W87iA9lo5v/HP18T5Eu6Zrf531ZN+0jEMxADhlnlhYFpoW9PBcd/AjsCw==", null, false, "", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "This is the Life movie description", new DateTime(2022, 7, 29, 21, 0, 52, 855, DateTimeKind.Local).AddTicks(8996), "", 4, "Life", 39.5, 1, new DateTime(2022, 7, 9, 21, 0, 52, 853, DateTimeKind.Local).AddTicks(4117) },
                    { 2, 2, "The untold story of one twelve-year-old's dream to become the world's greatest supervillain.", new DateTime(2022, 7, 29, 21, 0, 52, 856, DateTimeKind.Local).AddTicks(251), "https://sultan.blob.core.windows.net/attac/Minions.jpg", 2, "Minions: The Rise of Gru", 25.989999999999998, 1, new DateTime(2022, 7, 9, 21, 0, 52, 856, DateTimeKind.Local).AddTicks(237) },
                    { 3, 3, "Ivan sets off on a dangerous mission into Syria to save his ex-commander Grey after his capture by ISIS. With the help of U.S. military patrols, he succeeds in freeing Grey and attempts to escape the country while being hunted by terrorists.", new DateTime(2022, 7, 29, 21, 0, 52, 856, DateTimeKind.Local).AddTicks(259), "https://sultan.blob.core.windows.net/attac/Infiltration.png", 1, "Infiltration", 29.989999999999998, 2, new DateTime(2022, 7, 9, 21, 0, 52, 856, DateTimeKind.Local).AddTicks(256) },
                    { 4, 3, "A bookish marmoset embarks on a wild adventure to travel around the planet in 80 days after accepting a challenge from a greedy frog.", new DateTime(2022, 7, 29, 21, 0, 52, 856, DateTimeKind.Local).AddTicks(265), "https://sultan.blob.core.windows.net/attac/Around-the-World-in-80-Days.jpg", 1, "Around the World in 80 Days", 22.989999999999998, 2, new DateTime(2022, 7, 9, 21, 0, 52, 856, DateTimeKind.Local).AddTicks(262) }
                });
