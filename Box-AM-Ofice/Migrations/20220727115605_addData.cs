        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 21, " تامر حسني هو مغني، وكاتب أغاني، وملحن، وممثل، وكاتب سيناريو، ومخرج", "Tamer Hosny", "https://sultan.blob.core.windows.net/attac/TamerHosny.jpg" },
                    ...
                    { 2, "Is an Belgian actor ( born 18 October 1960  in Brussels, Belgium)", "Van Damme", "https://sultan.blob.core.windows.net/attac/Van_Damme.jpg" },
                    { 1, "Is an American actor and comedian (born August 16, 1962, Concord, Massachusetts, U.S.)", "Steven John", "https://sultan.blob.core.windows.net/attac/StevenJohn.jpg" },
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "ad376a8f", "6860681a-f93c-4f3f-a0e5-45a590d99141", "Administrator", "Administrator" });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "ConcurrencyStamp", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "a18be9c0", 0, "fa6e3305-4da0-4cf4-b30a-164f45507908", "Administrator@gmail.com", false, null, false, null, "Administrator@gmail.com", "Administrator", "AQAAAAEAACcQAAAAEGUMo2WURlqZyOpIk/LUN4YntBTkNdqG0imC23OlRMMOJjHs/kJflXln2/8NjpyEag==", null, false, "", false, "Administrator" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 9, " تامر حسني هو مغني، وكاتب أغاني، وملحن، وممثل، وكاتب سيناريو، ومخرج", "Tamer Hosny", "https://sultan.blob.core.windows.net/attac/TamerHosny.jpg" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "This is the Life movie description", new DateTime(2022, 8, 6, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(201), "https://sultan.blob.core.windows.net/attac/life.jpg", 4, "Life", 39.5, 1, new DateTime(2022, 7, 17, 14, 56, 3, 792, DateTimeKind.Local).AddTicks(852) },
                    { 2, 2, "The untold story of one twelve-year-old's dream to become the world's greatest supervillain.", new DateTime(2022, 8, 6, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3062), "https://sultan.blob.core.windows.net/attac/Minions.jpg", 2, "Minions: The Rise of Gru", 25.989999999999998, 1, new DateTime(2022, 7, 17, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3030) },
                    { 3, 3, "Ivan sets off on a dangerous mission into Syria to save his ex-commander Grey after his capture by ISIS. With the help of U.S. military patrols, he succeeds in freeing Grey and attempts to escape the country while being hunted by terrorists.", new DateTime(2022, 8, 6, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3083), "https://sultan.blob.core.windows.net/attac/Infiltration.png", 1, "Infiltration", 29.989999999999998, 2, new DateTime(2022, 7, 17, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3075) },
                    { 4, 3, "A bookish marmoset embarks on a wild adventure to travel around the planet in 80 days after accepting a challenge from a greedy frog.", new DateTime(2022, 8, 6, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3102), "https://sultan.blob.core.windows.net/attac/Around-the-World-in-80-Days.jpg", 1, "Around the World in 80 Days", 22.989999999999998, 2, new DateTime(2022, 7, 17, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3094) },
                    { 5, 3, "An American agent, under false suspicion of disloyalty, must discover and expose the real spy without the help of his organization.", new DateTime(2022, 8, 1, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3120), "https://sultan.blob.core.windows.net/attac/Mission-Impossible.png", 1, "Mission: Impossible", 26.989999999999998, 3, new DateTime(2022, 7, 22, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3112) },
                    { 6, 3, "Four years after the destruction of Isla Nublar, dinosaurs now live--and hunt--alongside humans all over the world.", new DateTime(2022, 8, 4, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3138), "https://sultan.blob.core.windows.net/attac/Jurassic-World-Dominion.jpg", 1, "Jurassic World Dominion", 10.99, 4, new DateTime(2022, 7, 20, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3130) },
                    { 7, 2, "A decidedly odd couple with ulterior motives convince Dr. Grant to go to Isla Sorna for a holiday, but their unexpected landing startles the island's new inhabitants..", new DateTime(2022, 8, 3, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3156), "https://sultan.blob.core.windows.net/attac/Jurassic-Park-III.jpg", 1, "Jurassic Park III", 30.989999999999998, 5, new DateTime(2022, 7, 25, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3148) },
                    { 8, 1, "A cowboy doll is profoundly threatened and jealous when a new spaceman action figure supplants him as top toy in a boy's bedroom.", new DateTime(2022, 8, 10, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3174), "https://sultan.blob.core.windows.net/attac/Toy-Story.jpg", 2, "Toy Story", 10.99, 6, new DateTime(2022, 7, 13, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3166) },
                    { 9, 1, "Shang-Chi, the master of weaponry-based Kung Fu, is forced to confront his past after being drawn into the Ten Rings organization..", new DateTime(2022, 8, 9, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3194), "https://sultan.blob.core.windows.net/attac/Shang-Chi.jpg", 1, "Shang-Chi and the Legend of the Ten Rings", 25.989999999999998, 7, new DateTime(2022, 7, 14, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3185) },
                    { 10, 2, "A bookish marmoset embarks on a wild adventure to travel around the planet in 80 days after accepting a challenge from a greedy frog.", new DateTime(2022, 8, 15, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3212), "https://sultan.blob.core.windows.net/attac/Thor-Ragnarok.jpg", 1, "Thor: Ragnarok", 25.989999999999998, 7, new DateTime(2022, 7, 8, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3204) },
                    { 11, 3, "سلطان ملاكم يجري ورا حلمه رغم الصعوبات تقوده الصدفه لتغيير حياته .", new DateTime(2022, 8, 6, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3230), "https://sultan.blob.core.windows.net/attac/3amhom.jpg", 2, "عمهم", 20.989999999999998, 8, new DateTime(2022, 7, 17, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3222) },
                    { 12, 2, "علي شاب عصامي من الطبقة المتوسطة يجد نفسه مجزأ بين حبيبته التي ينوي الزواج بها وخطيبته القديمة التي ظهرت في حياته من جديد. فماذا يملي عليه قلبه؟", new DateTime(2022, 8, 6, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3249), "https://sultan.blob.core.windows.net/attac/بحبك.jpg", 3, "بحبك", 21.989999999999998, 9, new DateTime(2022, 7, 17, 14, 56, 3, 799, DateTimeKind.Local).AddTicks(3240) }
                });
